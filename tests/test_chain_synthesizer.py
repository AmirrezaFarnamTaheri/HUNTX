...
def test_chain_synthesizer_domestic_relay_international_exit():
    ...
    nodes = [
        ...
        {"id": "n4", "server": "185.2.2.2", "port": 443, "protocol": "trojan",
            "country": "IR", "ping": 20, "alive": False},  # Dead
    ]
...
def test_chain_synthesizer_loop_prevention():
    ...
    nodes = [
        ...
        {"id": "n2", "server": "1.1.1.1", "port": 443, "protocol": "vless",
            "country": "DE", "ping": 30, "alive": True},  # Same address
    ]
    chains = synth.synthesize(nodes)
