...
class IngestionPipeline:
    ...
    def run(self, source_id: str, connector: SourceConnector, source_type: str = "telegram", deadline: float = None):
        ...
        state = self.state_repo.get_source_state(source_id, conn=None) or {}
        ...
        try:
            ...
            self.state_repo.update_source_state(source_id, new_state, source_type=source_type, conn=None)
            logger.info(
