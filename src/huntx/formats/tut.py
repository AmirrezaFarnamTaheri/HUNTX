...
class TutHandler(OpaqueBundleHandler):
    """Handler for .tut files with optional deep-decryption metadata."""
    ...
    def parse(
        ...
        try:
                    ...
                    return [
                        {
                            ...
                            "data": {
                                "filename": source_info.get("filename", f"{raw_hash}.tut"),
                                "blob_hash": raw_hash,
                                "size": len(raw_data),
                                "content": text,
                                "decrypted": decrypted,
            ...
            logger.debug("TUT deep parsing failed: %s", exc)
