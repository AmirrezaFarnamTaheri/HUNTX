...
class SksHandler(OpaqueBundleHandler):
    """Handler for .sks files with optional deep-decryption metadata."""
    ...
    def parse(
        ...
        try:
                    ...
                    return [
                        {
                            ...
                            "data": {
                                "filename": source_info.get("filename", f"{raw_hash}.sks"),
                                "blob_hash": raw_hash,
                                "size": len(raw_data),
                                "content": text,
                                "decrypted": decrypted,
            ...
            logger.debug("SKS deep parsing failed: %s", exc)
