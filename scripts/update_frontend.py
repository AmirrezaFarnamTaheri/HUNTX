...
<head>
  ...
  <meta name="description" content="Zero-budget sovereign proxy configuration aggregation, 3D telemetry radar, multi-format matrix converter, and real-time protocol decoder.">
...
<body class="bg-cyber-mesh min-h-screen flex flex-col antialiased selection:bg-cyan-500 selection:text-black">
  ...
  <!-- Zero-Dependency Standalone Bundle (CORS-Immune, works under file:/// and GitHub Pages) -->
