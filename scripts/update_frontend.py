  ...
  <style>
    ...
    * {
    ...
    .focus-ring:focus-visible {
      outline: none;
      box-shadow: 0 0 0 2px var(--accent-cyan), 0 0 0 4px var(--bg-void);
    }
    ...
    html.dark .nav-tab-btn.active {
      ...
      box-shadow: 0 4px 12px -2px rgba(0, 210, 255, 0.25) !important;
    }
    ...
    html.light .nav-tab-btn.active {
      ...
      box-shadow: 0 2px 8px -2px rgba(2, 132, 199, 0.25) !important;
    }
...
<body class="bg-cyber-mesh min-h-screen flex flex-col antialiased selection:bg-cyan-500 selection:text-black">
    ...
    <div class="max-w-7xl mx-auto flex items-center justify-between gap-2 overflow-x-auto no-scrollbar">
      <div class="flex items-center gap-1.5 sm:gap-2" role="tablist" aria-label="HUNTX Dashboard Tabs">
        ...
        >
          ...
          <span class="px-1.5 py-0.5 text-[9px] font-bold rounded bg-indigo-950/80 text-indigo-300 border border-indigo-800/60">STUDIO</span>
        </button>
        ...
        >
          ...
          <span id="tab-artifacts-count-badge" class="px-1.5 py-0.5 text-[9px] font-bold rounded bg-amber-950/80 text-amber-300 border border-amber-800/60">{{ARTIFACTS_COUNT}}</span>
        </button>
      </div>

      <div class="hidden lg:flex items-center gap-2 text-[11px] font-mono text-gray-500">
  ...
  <main class="flex-grow w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-16">
